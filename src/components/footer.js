...
const Footer = () => (
    <section className='relative bg-white z-50 pb-6 sm:flex sm:justify-between sm:text-right md:flex-col items-end md:items-center lg:flex-row lg: justify-between'>
