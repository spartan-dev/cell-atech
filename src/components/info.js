  ...
  <section className="container info-section">
    <div className="text-center mb-8 sm:mb-12 md:mb-16 lg:mb-20 xl:mb-12 lg:items-center lg:flex lg:flex-col">
      ...
      <p className="text-body text-black-3 lg:w-3/4">
        Whether your business has a complex network of distribution{" "}
        <br className="hidden lg:block xl:hidden" /> centers or just needs to
        get parts to the line fast, Cella Technologies{" "}
        <br className="hidden lg:block xl:hidden" /> has the solution to empower
        your material handling team.
      </p>
    </div>

    <div className="flex flex-wrap items-center container justify-center xl:justify-between">
      <div
        /* data-aos="fade-up" data-aos-anchor-placement="top-bottom" */ className="flex flex-wrap items-center container justify-center xl:justify-between"
      >
        <Card
          Img={Arrow}
      ...
      >
        <Card
          Img={Phone}
          title="Mobile WMS Platform"
          className="lg:mb-0"
          description={
            <>
              The power of the cloud in the hands of{" "}
              <br className="sm:hidden" /> your material handlers. Shop Mobile{" "}
              <br className="sm:hidden md:hidden lg:block xl:hidden" /> drives
              speed and accuracy for all of{" "}
              <br className="sm:hidden md:hidden lg:block xl:hidden" /> Cella's
              WMS tools.
            </>
          }
        />
        <Card
          Img={Person}
          title="Associate Utilization"
          className="lg:mb-0 lg:ml-8 xl:ml-0"
