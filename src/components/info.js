...
import Graphic from '../images/assets/graphic.png'
import Person from '../images/assets/person.png'
import Phone from '../images/assets/phone.png'

const InfoSection = () => (

    <section className='container mt-8 mb-16 sm:mt-12 md:mt-24 md:mb-24 lg:mb-40 xl:mt-32 xl:mb-40'>
        <div className='text-center mb-8 sm:mb-11 md:mb-16 lg:items-center lg:flex lg:flex-col'>
            <h2 className='subheader mb-5 text-black-1'>How We Can Help</h2>
